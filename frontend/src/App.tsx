...
function toOpportunitiesResponse(result: FullMarketScanResponse): OpportunitiesResponse {
  return {
    ...
    manual_action_center: result.manual_action_center,
    signal_monitor: result.signal_monitor,
    decision_quality_center: result.decision_quality_center,
    operational_readiness_center: result.operational_readiness_center,
    alpha_quality_center: result.alpha_quality_center,
