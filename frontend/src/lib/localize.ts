...
const ACTION_LABELS: LabelMap = {
  ...
  hold: { zh: "继续持有", en: "Hold" },
  stop_loss: { zh: "执行止损", en: "Stop loss" },
  take_profit: { zh: "止盈/上移止损", en: "Take profit / raise stop" },
  trim_or_raise_stop: { zh: "减仓/上移止损", en: "Trim / raise stop" },
  reduce_risk: { zh: "降低风险", en: "Reduce risk" },
  time_exit: { zh: "时间退出观察", en: "Time-exit watch" },
...
const STATUS_LABELS: LabelMap = {
  ...
  time_exit_watch: { zh: "时间退出观察", en: "Time-exit watch" },
  hold: { zh: "继续持有", en: "Hold" },
  stop_loss: { zh: "执行止损", en: "Stop loss" },
  take_profit: { zh: "止盈/上移止损", en: "Take profit / raise stop" },
  trim_or_raise_stop: { zh: "减仓/上移止损", en: "Trim / raise stop" },
...
const DATA_HEALTH_KEYS: LabelMap = {
  ...
  sector_strength: { zh: "板块强度", en: "Sector strength" },
  portfolio_allocations: { zh: "组合配置", en: "Portfolio allocations" },
  ...
  scan_result_cache: { zh: "扫描结果缓存", en: "Scan result cache" },
  scan_result_cache_key: { zh: "扫描缓存键", en: "Scan cache key" },
  scan_result_cache_id: { zh: "扫描缓存ID", en: "Scan cache ID" },
  ...
  paper_session_id: { zh: "模拟批次ID", en: "Paper session ID" },
  paper_session_status: { zh: "模拟批次状态", en: "Paper session status" },
  paper_session_label: { zh: "模拟批次名称", en: "Paper session label" },
  paper_initial_capital: { zh: "模拟初始资金", en: "Paper initial capital" },
  paper_allocation_per_trade_pct: { zh: "单票模拟仓位", en: "Paper allocation" },
  paper_max_positions: { zh: "模拟最大持仓", en: "Paper max positions" },
  paper_transaction_cost_bps: { zh: "模拟手续费", en: "Paper fee bps" },
  paper_slippage_bps: { zh: "模拟滑点", en: "Paper slippage bps" },
  paper_take_profit_pct: { zh: "模拟首目标止盈", en: "Paper take-profit pct" },
  ...
  a_share_enhanced_provider: { zh: "A股增强源", en: "A-share enhanced provider" },
  a_share_enhanced_requested: { zh: "增强请求数", en: "Enhanced requested" },
  a_share_enhanced_snapshots: { zh: "增强快照", en: "Enhanced snapshots" },
  a_share_enhanced_score: { zh: "增强均分", en: "Enhanced score" },
  a_share_enhanced_fund_flow_positive: { zh: "资金净流入", en: "Positive fund flow" },
  a_share_enhanced_dragon_tiger_recent: { zh: "龙虎榜近端", en: "Recent dragon tiger" },
  a_share_enhanced_limit_members: { zh: "涨停池成员", en: "Limit-pool members" },
  a_share_enhanced_risk_warnings: { zh: "增强风险", en: "Enhanced risk warnings" },
  ...
  a_share_adjusted_price_coverage: { zh: "最新交易日有效复权价覆盖", en: "Latest-session valid adjusted-price coverage" },
  a_share_adjusted_price_missing: { zh: "最新交易日复权价缺失", en: "Latest-session adjusted prices missing" },
  a_share_adjusted_price_missing_samples: { zh: "复权价缺失样例", en: "Adjusted-price missing samples" },
  a_share_adjusted_price_source_mix: { zh: "有效复权价来源", en: "Valid adjusted-price source mix" },
  a_share_adjusted_price_missing_source_mix: { zh: "缺失复权价原始来源", en: "Missing adjusted-price raw source mix" },
  a_share_adjustment_type_mix: { zh: "复权类型分布", en: "Adjustment type mix" },
  a_share_adjusted_price_semantics: { zh: "复权覆盖口径", en: "Adjusted coverage semantics" },
  a_share_adjusted_price_scope: { zh: "旧版复权覆盖范围", en: "Legacy adjusted coverage scope" },
  a_share_operational_price: { zh: "运营价格就绪度", en: "Operational price readiness" },
  a_share_operational_price_coverage: { zh: "运营价格覆盖", en: "Operational price coverage" },
  a_share_operational_price_semantics: { zh: "运营价格口径", en: "Operational price semantics" },
  a_share_stock_adjusted_price: { zh: "A股股票复权价格", en: "A-share stock adjusted price" },
  a_share_stock_adjusted_price_coverage: { zh: "股票最新交易日复权覆盖", en: "Stock latest-session adjusted coverage" },
  a_share_stock_adjusted_price_missing: { zh: "股票最新交易日复权缺失", en: "Stock latest-session adjusted missing" },
  a_share_stock_adjusted_price_semantics: { zh: "股票复权覆盖口径", en: "Stock adjusted coverage semantics" },
  a_share_etf_raw_price: { zh: "ETF 原始价格", en: "ETF raw price" },
  a_share_etf_raw_price_coverage: { zh: "ETF 最新交易日原始价格覆盖", en: "ETF latest-session raw-price coverage" },
  a_share_etf_raw_price_missing: { zh: "ETF 最新交易日原始价格缺失", en: "ETF latest-session raw prices missing" },
  a_share_etf_raw_price_semantics: { zh: "ETF 原始价格覆盖口径", en: "ETF raw-price coverage semantics" },
  a_share_etf_total_return_adjusted_price: { zh: "ETF 总收益复权价格", en: "ETF total-return adjusted price" },
  a_share_etf_total_return_adjusted_price_coverage: { zh: "ETF 总收益复权覆盖", en: "ETF total-return adjusted coverage" },
  a_share_etf_total_return_adjusted_price_missing: { zh: "ETF 总收益复权缺失", en: "ETF total-return adjusted missing" },
  a_share_etf_total_return_adjusted_price_source_mix: { zh: "ETF 总收益复权来源", en: "ETF total-return adjusted source mix" },
  a_share_etf_total_return_adjusted_price_semantics: { zh: "ETF 总收益复权口径", en: "ETF total-return adjusted semantics" },
  ...
  recommendation_calibration_samples: { zh: "推荐校准样本", en: "Recommendation calibration samples" },
  recommendation_calibration_completed: { zh: "校准完成样本", en: "Calibration completed samples" },
  recommendation_calibration_score_bands: { zh: "校准分数层", en: "Calibration score bands" },
  recommendation_calibration_signal_effects: { zh: "校准信号效果", en: "Calibration signal effects" },
  recommendation_calibration_curve_points: { zh: "校准曲线点", en: "Calibration curve points" },
  ...
  universe_dynamic_selected: { zh: "动态样本", en: "Dynamic sample" },
  universe_supplements: { zh: "补充覆盖", en: "Supplement coverage" },
  universe_supplemental_selected: { zh: "补充标的", en: "Supplemental selected" },
  universe_components: { zh: "覆盖构成", en: "Coverage components" },
  ...
  full_market_catalog: { zh: "全市场目录", en: "Full-market catalog" },
  full_market_catalog_total: { zh: "全市场目录总数", en: "Full-market catalog total" },
  full_market_include_etfs: { zh: "包含ETF", en: "Include ETFs" },
  full_market_requested: { zh: "请求扫描数", en: "Requested scan count" },
  full_market_batch_size: { zh: "批次大小", en: "Batch size" },
  full_market_batches: { zh: "批次数", en: "Batches" },
  full_market_cards_returned: { zh: "返回机会卡", en: "Returned cards" },
  full_market_cards_total: { zh: "全市场机会卡", en: "Full-market cards" },
  full_market_scan_mode: { zh: "全市场扫描模式", en: "Full-market scan mode" },
  full_market_total_symbols: { zh: "全市场标的数", en: "Full-market symbols" },
  legacy_cards_hydrated: { zh: "旧机会卡补全", en: "Legacy cards hydrated" },
  strategy_health_source: { zh: "策略验证来源", en: "Strategy health source" },
  strategy_health_source_cache_id: { zh: "策略验证缓存ID", en: "Strategy health cache ID" },
  strategy_data_skipped: { zh: "策略数据跳过", en: "Strategy data skipped" },
  brief_provider: { zh: "简报数据源", en: "Brief provider" },
  brief_symbols: { zh: "简报标的数", en: "Brief symbols" },
  brief_requested_symbols: { zh: "简报请求股票池", en: "Brief requested universe" },
  brief_news_symbols: { zh: "新闻标的", en: "News symbols" },
  brief_mode: { zh: "简报模式", en: "Brief mode" },
  brief_scan_limit: { zh: "扫描上限", en: "Scan limit" },
  brief_news: { zh: "新闻", en: "News" },
  brief_backtest: { zh: "回测", en: "Backtest" },
  brief_skip_backtest: { zh: "跳过回测", en: "Skip backtest" },
  brief_cache: { zh: "简报缓存", en: "Brief cache" },
  brief_cache_id: { zh: "简报缓存ID", en: "Brief cache ID" },
  brief_cache_mode: { zh: "简报缓存模式", en: "Brief cache mode" },
  brief_cache_created_at: { zh: "简报缓存时间", en: "Brief cache time" },
...
const DATA_HEALTH_VALUES: LabelMap = {
  ...
  fast: { zh: "快照", en: "Fast" },
  full: { zh: "完整", en: "Full" },
  full_market_scan: { zh: "全市场扫描", en: "Full-market scan" },
  full_market_batch: { zh: "全市场批扫", en: "Full-market batch" },
...
const PROVIDER_NAME_LABELS: LabelMap = {
  ...
  "扶摇同花顺金融数据 API": { zh: "扶摇同花顺金融数据 API", en: "Fuyao THS Financial Data API" },
};
...
const CAPABILITY_LABELS: LabelMap = {
  ...
  cn_daily_ohlcv_fallback: { zh: "A股日线兜底", en: "A-share daily fallback" },
  adjusted_daily_ohlcv: { zh: "复权日线", en: "Adjusted daily OHLCV" },
  cn_snapshot_read_only: { zh: "A股实时快照", en: "A-share live snapshot" },
  index_data: { zh: "指数与成分", en: "Index and constituents" },
  fund_and_etf_data: { zh: "ETF与基金", en: "ETF and fund data" },
  financials_and_valuations: { zh: "财务与估值", en: "Financials and valuations" },
  special_data: { zh: "涨停、热榜与异动", en: "Limit, hot-list and anomaly data" },
  realtime_snapshot: { zh: "实时快照", en: "Live snapshot" },
  daily_ohlcv_raw: { zh: "未复权日线", en: "Raw daily OHLCV" },
  daily_ohlcv_forward_adjusted: { zh: "前复权日线", en: "Forward-adjusted daily OHLCV" },
  trading_calendar: { zh: "交易日历", en: "Trading calendar" },
  corporate_actions: { zh: "复权事件", en: "Corporate actions" },
  ticker_search: { zh: "标的检索", en: "Ticker search" },
  ticker_catalog: { zh: "标的目录", en: "Ticker catalog" },
  income_statement: { zh: "利润表", en: "Income statement" },
  balance_sheet: { zh: "资产负债表", en: "Balance sheet" },
  cash_flow_statement: { zh: "现金流量表", en: "Cash-flow statement" },
  financial_indicators: { zh: "财务指标", en: "Financial indicators" },
  valuation_snapshot: { zh: "估值快照", en: "Valuation snapshot" },
  index_catalog: { zh: "指数目录", en: "Index catalog" },
  index_constituents: { zh: "指数成分", en: "Index constituents" },
  index_snapshot: { zh: "指数快照", en: "Index snapshot" },
  index_daily_ohlcv: { zh: "指数日线", en: "Index daily OHLCV" },
  fund_profile: { zh: "基金资料", en: "Fund profile" },
  fund_holdings: { zh: "基金持仓", en: "Fund holdings" },
  fund_holders: { zh: "基金持有人", en: "Fund holders" },
  fund_nav: { zh: "基金净值", en: "Fund NAV" },
  fund_returns: { zh: "基金收益", en: "Fund returns" },
  etf_snapshot: { zh: "ETF快照", en: "ETF snapshot" },
  etf_daily_ohlcv: { zh: "ETF日线", en: "ETF daily OHLCV" },
  limit_up_pool: { zh: "涨停池", en: "Limit-up pool" },
  limit_up_ladder: { zh: "连板梯队", en: "Limit-up ladder" },
  hot_stock_list: { zh: "热股榜", en: "Hot-stock list" },
  skyrocket_list: { zh: "热度飙升榜", en: "Skyrocket list" },
  hot_stock_history: { zh: "历史热股", en: "Hot-stock history" },
  hot_stock_rank_trend: { zh: "热榜排名走势", en: "Hot-rank trend" },
  anomaly_analysis: { zh: "异动原因", en: "Anomaly analysis" },
