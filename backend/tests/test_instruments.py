...
def test_formats_known_a_share_with_company_name_and_exchange_suffix():
    ...
    assert format_instrument_label("CN:688059") == "华锐精密 688059.SH"
    assert format_instrument_label("CN:000021") == "深科技 000021.SZ"
    assert format_instrument_label("CN:000030") == "富奥股份 000030.SZ"
...
def test_formats_cn_index_tokens_and_etfs():
    ...
    assert format_instrument_label("CN:THEME:MEMORY") == "存储芯片主题"
