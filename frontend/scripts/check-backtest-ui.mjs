...
const checks = [
  ...
  ["portfolio registers frozen challenger recipes", files.portfolio.includes("下一项冻结 challenger") && files.portfolio.includes("onRun(selectedCandidate)") && files.portfolio.includes('value="trend-health-composite-v1"') && files.portfolio.includes('value="turnover-volume-strength-v1"') && files.client.includes("candidate_id")],
