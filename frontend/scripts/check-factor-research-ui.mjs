...
const checks = [
  ...
  ["types expose ranking head challenger", files.types.includes("RankingHeadChallengerEvaluation")],
  ["portfolio renders factor shadow Top5 Top10 comparison", files.portfolio.includes("Factor Shadow 挑战者排名 Top")],
  ["portfolio disclaims official Ranking V3 identity", files.portfolio.includes("它不是 Ranking V3 正式模型")],
  ["portfolio keeps rank 6-10 outside Top5", files.portfolio.includes("第6-10名不会进入 Top5 头部")],
