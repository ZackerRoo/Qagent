...
def run_matched_control(source: dict, repository: ReplayEvidenceRepository) -> dict:
    ...
    return {
        ...
        "limitations": [
            ...
            "Candidate resolution distinguishes invalid plans, insufficient data, absent triggers and unfillable entries when evidence permits; missing execution evidence remains unknown.",
            "size_zero alone does not establish cash causality; its first_failure and raw sizing evidence distinguish budget, minimum quantity, executable quantity and proven cash constraints, with unknown retained when evidence is insufficient.",
