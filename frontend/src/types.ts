...
export type AutomationRuntimeHealth = {
  ...
  market_data_reliability_job_id: string | null;
  ...
  market_data_source_mix: string | null;
  market_data_current_source_mix: string | null;
  market_data_stale_source_mix: string | null;
  market_data_stale_age_mix: string | null;
  market_data_missing_reason_mix: string | null;
  market_data_problem_status_mix: string | null;
  market_data_problem_samples: string | null;
